...
# ── Emotional Profile (Akane defaults) ────────────────────────────────────────

DEFAULT_AKANE_PROFILE = {
    "emotional_leakage": 0.75,
...
# ── Build Temporal Context (v2.3 extended) ──────────────────────────────────────
...
def build_temporal_context(
    ...
    profile = _profile or DEFAULT_AKANE_PROFILE

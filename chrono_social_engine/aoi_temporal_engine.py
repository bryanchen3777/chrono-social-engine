"""
akane_temporal_engine.py  v2.1
職責：把「現在幾點＋關係狀態」轉成「日南葵的心理中介層狀態」
...
# ── Emotional Profile (Aoi defaults) ────────────────────────────────────────
...
# abandonment_sensitivity = 0.30  # 恐懼是「框架外什麼都沒有」，不是被拋棄
# facade_collapse_rate    = 0.15  # 崩是「卡住」，不是爆發
...
def build_temporal_context(
    ...
    profile = _profile or DEFAULT_AOI_PROFILE
    ...
    # NOTE: Aoi C1 = facade_intensification（表現為更完美，不是話變少）
    # NOTE: Aoi C2 = framework_stress（語尾不穩，話說到一半）
    # NOTE: Aoi C3 = true_crack（話說不下去，長時間沉默）
